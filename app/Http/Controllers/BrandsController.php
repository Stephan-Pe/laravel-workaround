...
class BrandsController extends Controller
{
    ...
    $validatedData = $request->validate([
        ...
        [
            'brand_name.required' => 'Please fill out Brand Name',
            'brand_name.min' => 'At last 4 Characters!',
    ]);
    ...
    public function Delete($id) {
        ...
        return Redirect()->back()->with('success', 'Brand is permanently deleted');
    }
    ...
    public function StoreImage(Request $request) {
        ...
        foreach($image as $multi_img) {
            ...
            Image::make($multi_img)->resize(400, 300)->save('image/multi/'. $img_name);
    ...
    public function Logout() {
        Auth::logout();
        return Redirect()->route('login')->with('succes', 'Successfully logged out');
    }
}
